...
PriceOracle.prototype.getPrice = function(chainId, baseCurrency, quoteCurrency) {
  ...
  return new Promise(function(onResolve, onReject) {
    ...
    cacheImplementer.get(helper.oraclePricePointKey(chainId, contractAddress)).then(function(cacheResponse) {
      ...
      if (cacheResponse.isSuccess() && cachedPrice != undefined && cachedPrice != 'null') {
        ...
        helper.call(web3Provider, contractAddress, encodedABI, {}, transactionOutputs).then(function(response) {
...
(PriceOracle.prototype.decimalPrice = function(chainId, baseCurrency, quoteCurrency) {
  ...
  return new Promise(function(onResolve, onReject) {
    ...
    oThis.getPrice(chainId, baseCurrency, quoteCurrency).then(function(response) {
  ...
  (PriceOracle.prototype.setPrice = function(chainId, baseCurrency, quoteCurrency, price, gasPrice) {
    ...
    return new Promise(function(onResolve, onReject) {
      ...
      helper
        .sendTxAsync(web3Provider, response.data.contractAddress, response.data.encodedABI, opsName, {
          gasPrice: gasPrice,
          gas: gasLimit
        })
        .then(function(transactionHash) {
          ...
          // Flush Cache
          helper.getTxReceipt(web3Provider, transactionHash).then(function(receipt) {
  ...
  (PriceOracle.prototype.setPriceInSync = function(chainId, baseCurrency, quoteCurrency, price, gasPrice) {
    ...
    return helper
      .safeSend(web3Provider, response.data.contractAddress, response.data.encodedABI, opsName, {
        gasPrice: gasPrice,
        gas: gasLimit
      })
      .then(function(transactionReceipt) {
        ...
        logger.debug('----------------------------------------------------------------------');
        helper.flushSetPriceCache(chainId, response.data.contractAddress).then(function() {
  ...
  (PriceOracle.prototype.getExpirationHeight = function(chainId, baseCurrency, quoteCurrency) {
    ...
    return new Promise(function(onResolve, onReject) {
      ...
      const encodedABI = transactionObject.encodeABI();
      const transactionOutputs = helper.getTransactionOutputs(transactionObject);
      cacheImplementer.get(helper.oracleExpirationHeightKey(chainId, contractAddress)).then(function(cacheResponse) {
